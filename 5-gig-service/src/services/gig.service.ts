...
// import { IRatingTypes, IReviewMessageDetails, ISellerDocument, ISellerGig } from '@fvoid/shared-lib';
...
const updateGig = async (gigId: string, gigData: ISellerGig): Promise<ISellerGig | null> => {
