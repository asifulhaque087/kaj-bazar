...
export const createSellerValues = (
  buyer?: Buyer | null
): Partial<CreateSellerFormFields> => {
  // These are static defaults that don't depend on authUser
  const baseDefaults: Partial<CreateSellerFormFields> = {
    fullName: "John Doe",
