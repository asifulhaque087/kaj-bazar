        ...
        <div className="flex h-[90vh] gap-x-[20px]">
          ...
          <div className="xl:overflow-y-auto grow">
            <div className="grid grid-cols-12 gap-[24px]">
              {/* 1st gig image card*/}
              <div
                className="col-span-12 xl:col-span-8 rounded-[10px] h-[344px]  flex flex-col p-[20px] bg-white"
              ...
              {/* 2nd price card */}
              <div className="col-span-12 sm:col-span-6 xl:col-span-4 p-[30px]  shadow flex flex-col gap-y-[20px]  items-center justify-center bg-white rounded-[10px]">
              ...
              {/* 3rd card user information */}
              <div className="xl:hidden col-span-12 sm:col-span-6 xl:col-span-3 p-[30px]  shadow flex flex-col gap-y-[20px]  items-center justify-center bg-white rounded-[10px]">
                      ...
                      >
                        <div className="flex flex-col gap-y-[14px]">
                          ...
                          <p className="text-[16px] font-[roboto] text-[#333]">
                            ...
                            elit. Quisquam quam omnis recusandae sequi quo
                            magnam esse atque ipsa? Ullam, doloremque veniam?
            ...
            <div className="text-center flex flex-col gap-y-[10px]">
              ...
              <div className="flex flex-wrap gap-[10px] items-center justify-center">
                {[...Array(6)].map((item, index) => (
                  <div
                    className="grow rounded-[6px] text-[14px] sm:text-[14px] px-[16px] py-[8px]  border border-[#6392D8]]  bg-white text-[#333] shadow"
                    key={index}
                  >
                    <span>content</span>
                  </div>
