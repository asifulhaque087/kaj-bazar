  ...
  return (
    <>
      <div className="flex gap-[14px]">
        <div className="grow xl:h-[666px] xl:w-[50%] rounded-[14px] bg-[#0D0E12] min-h-[474px] relative overflow-hidden px-[14px] flex justify-center items-center">
          {/* Background */}
        ...
        {/* --- right --- */}
        <div className="xl:w-[50%] grow hidden xl:flex flex-col gap-y-[14px]">
          {/* --- row 1 --- */}
          <div className="flex h-[50%] gap-x-[14px]">
            {/* --- col 1 --- */}
            <div
              className="basis-[50%] overflow-hidden rounded-[13px]"
              style={{
          ...
          {/* --- row 2 --- */}
          <div
            className="bg-indigo-400 h-[50%]  overflow-hidden rounded-[13px]"
            style={{
