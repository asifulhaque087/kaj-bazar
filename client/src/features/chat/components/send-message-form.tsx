import { createMessageDefaultForm } from "@/features/chat/default-form-values/chat.form";
import { useCreateMessage } from "@/features/chat/mutations/use-create-message.mutation";
import {
  createMessageForm,
  CreateMessageForm,
} from "@/features/chat/schemas/create-message.schema";
import SendOfferModal from "@/features/order/components/send-offer-modal";
