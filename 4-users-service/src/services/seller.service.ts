...
import { IOrderMessage, IRatingTypes, IReviewMessageDetails, ISellerDocument } from '@fvoid/shared-lib';
...
const removeSellers = async (): Promise<string> => {
  await SellerModel.deleteMany();

  return 'remove all sellers';
};
